...
var KTMenu = function(elementId, options) {
    ...
    var Plugin = {
        ...
        build: function() {
            ...
            the.eventHandlers['event_6'] = KTUtil.on(element, '.menu-item-custom > .menu-link:not(.menu-toggle):not(.menu-link-toggle-skip)', 'click', Plugin.handleLinkClick);
        ...
        */
        ...
        handleSubmenuDropdownClick: function(e) {
            ...
            var item = this.closest('.menu-item-custom');
        ...
        handleLinkClick: function(e) {
            var submenu = this.closest('.menu-item-custom.menu-item-submenu');
        ...
        handleSubmenuDropdownClose: function(e, el) {
            ...
            var shown = element.querySelectorAll('.menu-item-custom.menu-item-submenu.menu-item-hover:not(.menu-item-tabs)');
        ...
        handleSubmenuAccordion: function(e, el) {
            ...
            if ( Plugin.getSubmenuMode(el) === 'dropdown' && (query = item.closest('.menu-item-custom') ) ) {
            ...
            var li = item.closest('.menu-item-custom');
            var submenu = KTUtil.child(li, '.menu-submenu, .menu-inner');

            if (KTUtil.hasClass(item.closest('.menu-item-custom'), 'menu-item-open-always')) {
                return;
            }
            ...
            if ( li && submenu ) {
                ...
                if ( KTUtil.hasClass(li, 'menu-item-open') === false ) {
                    ...
                    if ( the.options.accordion.expandAll === false ) {
                        ...
                        var closables = KTUtil.children(subnav, '.menu-item-custom.menu-item-open.menu-item-submenu:not(.menu-item-here):not(.menu-item-open-always)');
...
document.addEventListener("click", function (e) {
    ...
    var query;
    if ( query = body.querySelectorAll('.menu-nav .menu-item-custom.menu-item-submenu.menu-item-hover:not(.menu-item-tabs)[data-menu-toggle="click"]') ) {
